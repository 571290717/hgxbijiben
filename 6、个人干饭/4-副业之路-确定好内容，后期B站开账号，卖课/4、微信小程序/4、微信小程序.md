...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#文件内代码架构的变化)文件内代码架构的变化
...
- 现在 `template` 是一级节点，用于写tag组件， `script` 和 `style` 是并列的一级节点，也就是有3个一级节点。这个叫[vue单文件组件规范sfc](https://uniapp.dcloud.net.cn/tutorial/vue3-components)。
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#外部文件引用方式变化)外部文件引用方式变化
...
**另外，vue支持组件导入，可以更方便的封装一个包括界面、js、样式的库**。[详见](https://uniapp.dcloud.net.cn/tutorial/vue3-components)

### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#组件-标签的变化)组件/标签的变化
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#js的变化)js的变化
...
## [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#在-uni-app-中使用vue的差异)在 uni-app 中使用vue的差异
...
- 受限：相比 Web 平台，在小程序和 App 端部分功能支持不完善，具体见[兼容性列表](https://uniapp.dcloud.net.cn/vue3-api)。
...
## [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#模板语法)模板语法

`Vue.js` 使用了基于 `HTML` 的模板语法，允许开发者声明式地将 `DOM` 绑定至底层组件实例的数据。 所有 `Vue.js` 的模板都是合法的 `HTML`，所以能被遵循规范的浏览器和 `HTML` 解析器解析。

在底层的实现上，`Vue` 将模板编译成虚拟 `DOM` 渲染函数。结合响应性系统，`Vue` 能够智能地计算出最少需要重新渲染多少组件，并把 `DOM` 操作次数减到最少。

### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#插值)插值

#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#文本)文本
...
#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#使用-javascript-表达式)使用 JavaScript 表达式
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#指令)指令
...
#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#v-bind)v-bind
...
#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#v-on)v-on
...
#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#v-once)v-once
...
#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#v-html)v-html
...
## [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#data-选项)Data 选项
...
## [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#class-与-style-绑定)Class 与 Style 绑定

### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#绑定-html-class)绑定 HTML Class
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#绑定内联样式)绑定内联样式
...
## [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#条件渲染)条件渲染

### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#v-if和v-else)v-if和v-else
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#条件渲染分组)条件渲染分组
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#v-show)v-show
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#v-if-和-v-show-区别)v-if 和 v-show 区别
...
## [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#列表渲染)列表渲染

### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#在-v-for-里使用数组)在 v-for 里使用数组
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#在-v-for-里使用对象)在 v-for 里使用对象
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#列表渲染分组)列表渲染分组
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#维护状态)维护状态
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#注意事项)注意事项
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#结合-template-v-for)结合 `<template v-for>`
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#在组件上使用-v-for)在组件上使用 v-for
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#v-for-与-v-if-一同使用)v-for 与 v-if 一同使用
...
## [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#事件处理)事件处理

### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#监听事件)监听事件
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#事件处理方法)事件处理方法
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#内联处理器中的方法)内联处理器中的方法
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#多事件处理器)多事件处理器
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#事件修饰符)事件修饰符
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#事件映射表)事件映射表
...
## [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#表单输入绑定)表单输入绑定

### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#v-model)v-model
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#uni-app表单组件)uni-app表单组件

建议开发过程中直接使用 `uni-app`：[表单组件](https://uniapp.dcloud.io/component/button)。

##### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#用法示例)用法示例：
...
## [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#计算属性和侦听器)计算属性和侦听器

### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#计算属性computed)计算属性computed

每一个计算属性都包含一个 `getter` 函数和一个 `setter`函数 ，默认是利用 `getter` 函数来读取。所有 `getter` 和 `setter` 函数的 `this` 上下文自动地绑定为 Vue 实例。

#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#计算属性的-getter)计算属性的 getter
...
#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#计算属性的-setter)计算属性的 setter
...
#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#getter与setter区别)getter与setter区别

- get：通过设置get方法可以得到fullName的新值。
- set：通过set的方法，设置一个值（newValue）来改变fullName相关联的值，引起fullName重新的计算，相应的页面上fullName也会发生改变成新的内容。

### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#计算属性缓存-vs-方法)计算属性缓存 vs 方法
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#侦听器watch)侦听器watch
...
#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#监听变量的值变化)监听变量的值变化
...
#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#选项-immediate)选项：immediate
...
#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#选项-deep)选项：deep
...
#### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#监听对象中单个属性)监听对象中单个属性
...
### [#](https://uniapp.dcloud.net.cn/tutorial/vue3-basics.html#计算属性-vs-侦听属性)计算属性 vs 侦听属性
