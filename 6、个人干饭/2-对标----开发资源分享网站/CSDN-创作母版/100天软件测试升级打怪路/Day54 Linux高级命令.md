...
![useradd命令](image/useradd-2.png) ![useradd命令](image/useradd-3.png)
...
![FileZilla](image/f1.png) ![FileZilla](image/f2.png) ![FileZilla](image/f3.png) ![FileZilla](image/f4.png)
...
![可视化方式更改镜像源](image/可视化修改-1.png) ![可视化方式更改镜像源](image/可视化修改-2.png) ![可视化方式更改镜像源](image/可视化修改-3.png) ![可视化方式更改镜像源](image/可视化修改-4.png) ![可视化方式更改镜像源](image/可视化修改-5.png) ![可视化方式更改镜像源](image/可视化修改-6.png) ![可视化方式更改镜像源](image/可视化修改-7.png)

**手动方式更改镜像源:**

![手动方式更改镜像源](image/手动修改-1.png) ![手动方式更改镜像源](image/手动修改-2.png) ![手动方式更改镜像源](image/手动修改-3.png) ![手动方式更改镜像源](image/手动修改-4.png) ![手动方式更改镜像源](image/手动修改-5.png) ![手动方式更改镜像源](image/手动修改-6.png) ![手动方式更改镜像源](image/手动修改-7.png)
