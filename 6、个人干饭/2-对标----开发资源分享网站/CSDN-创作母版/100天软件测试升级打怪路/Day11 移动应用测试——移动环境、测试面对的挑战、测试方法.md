...
![image-20230606100313512](image/image-20230606100313512-16860169948861.png)
...
安装
--软件在不同操作系统（Palm OS、Symbian、Linux、Android、iOS、Black Berry OS 6.0、Windows Phone7）下安装是否正常。
...
升级/更新测试：新版版发布后，配合不同网络环境的自劢更新提示及下载、安装、更新、启劢、运行的验证测试。 
...
> 如果工作中涉及到移动应用测试，本篇尤为重要
>
> 需要仔细阅读，总结部分11个测试方向最好背着



![9c7bc198b36f77679bc7983f2f02810](image/9c7bc198b36f77679bc7983f2f02810-16860170081742.jpg)
