...
class salary:
    ...
    def login(self):
        '''登录'''
        self.driver.find_element_by_xpath('//*[@id="iptUserID"]').send_keys('180927')
        self.driver.find_element_by_xpath('//*[@id="iptPassword"]').send_keys('qwe!23456789')
        self.driver.find_element_by_xpath('//*[@id="iptEmpNum"]').send_keys('100215998')
...
url = 'http://salary.gree.com/PublicNotice/Account/EmpCheckLogin.aspx'
    # 定义driver驱动为谷歌的驱动
...
class Jiaban:
    ...
    def login(self):
        '''登录'''
        self.driver.find_element_by_xpath('//*[@id="txtLoginID"]').send_keys('180927')
        self.driver.find_element_by_xpath('//*[@id="txtPassword"]').send_keys('qwe!23456789')
        self.driver.find_element_by_xpath('//*[@id="btnLogin"]').click()
        sleep(1)
    ...
    def Frame(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="txtEmployeeNo"]').send_keys("100215998")
        ...
        self.driver.find_element_by_xpath('//*[@id="txtTimeProvePerson"]').send_keys("杨静")
        sleep(2)
